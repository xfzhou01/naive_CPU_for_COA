...
HD_PWD='C:/Users/84546/Desktop/CPU/CPU.runs/MCU_mem_dist_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_mem_dist_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_mem_dist_mem_gen_0_1.tcl
