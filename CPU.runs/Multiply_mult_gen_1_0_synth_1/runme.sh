...
HD_PWD='C:/Users/84546/Desktop/CPU/CPU.runs/Multiply_mult_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiply_mult_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiply_mult_gen_1_0.tcl
