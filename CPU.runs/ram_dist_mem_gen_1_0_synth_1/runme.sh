...
HD_PWD='C:/Users/84546/Desktop/CPU/CPU.runs/ram_dist_mem_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_dist_mem_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_dist_mem_gen_1_0.tcl
